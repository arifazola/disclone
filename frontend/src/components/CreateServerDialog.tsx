...
const CreateServerDialog = ({ isOpened, closeDialog }: CreateServerDialogProps) => {
    ...
    const onFileChanged = async (files: FileList | null) => {
        ...
        try {
            ...
            const res = await getUploadUrl.json()
    ...
    const renderDialogContent = () => {
        if (content == "create") {
            return (
                <div id='content' className='w-1/3 bg-white rounded-lg flex flex-col items-center p-10 gap-5'>
                    ...
                    <div className='w-full flex justify-between items-center'>
                        ...
                        <div className='w-20'>
                            <ButtonPrimary text='Create' onClick={createServer} />
                        </div>
                    </div>
                </div>
            )
            ...
            return <JoinServerDialog closeDialog={closeDialog} />
        }
    }
    return (
